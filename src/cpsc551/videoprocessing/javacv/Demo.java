...
public class Demo {
    public static void main(String[] args) throws Exception {
        String classifierName = "resource/haarcascade_frontalface_alt.xml";
//        if (args.length > 0) {
...
//        }
        ...
        OpenCVFrameGrabber grabber = new OpenCVFrameGrabber("resource/Mission.avi");
        grabber.start();
        ...
        while (frame.isVisible() && (grabbedImage = grabber.grab()) != null) {
            ...
            if(faces.total() > 0)
            	cvSaveImage("image" + counter.toString() + ".jpg", grabbedImage);
